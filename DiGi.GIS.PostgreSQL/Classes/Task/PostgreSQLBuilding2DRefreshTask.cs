...
{
    public class PostgreSQLBuilding2DRefreshTask : CancelableTask, IGISPostgreSQLObject
    {
        ...
        /// </summary>
        public Building2DPostgreSQLRefreshOptions Options { get; set; } = new Building2DPostgreSQLRefreshOptions();
        ...
        protected override async Task<bool> RunAsync(CancellationToken cancellationToken)
        {
            ...
            return await building2DPostgreSQLConverter.RefreshAsync(Options, cancellationToken);
        }
    }
}